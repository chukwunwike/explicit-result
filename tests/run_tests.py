...
run("ok_truthy_raises",        lambda: assert_(raises(RuntimeError, lambda: bool(Ok(0)))))
run("err_truthy_raises",       lambda: assert_(raises(RuntimeError, lambda: bool(Err("x")))))
...
run("some_truthy_raises",      lambda: assert_(raises(RuntimeError, lambda: bool(Some(0)))))
run("nothing_truthy_raises",   lambda: assert_(raises(RuntimeError, lambda: bool(Nothing))))
